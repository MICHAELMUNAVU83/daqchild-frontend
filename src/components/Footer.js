...
const Footer = () => {
  return (
    <div className="bg-black h-full text-white md:p-4 p-2 z-0 ">
      <p className="text-center p-3 text-[#9d6ef4] text-4xl">FOLLOW ME</p>
      ...
      <section className="flex flex-col mt-10 md:gap-24 gap-10 md:flex-row justify-center my-4 items-center">
        <div className="flex flex-col justify-center items-center ">
          <p className="text-center p-3 text-[#9d6ef4] text-4xl">MIXES</p>
        ...
        <div className="flex flex-col justify-center items-center">
          <p className="text-center p-3 text-[#9d6ef4] text-4xl">Merchandise</p>
        ...
        <div className="flex flex-col justify-center items-center">
          <p className="text-center p-3 text-[#9d6ef4] text-4xl">Contact</p>
